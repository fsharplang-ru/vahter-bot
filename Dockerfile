FROM --platform=linux/arm64 mcr.microsoft.com/dotnet/sdk:8.0-jammy-arm64v8 AS build-env
...
FROM --platform=linux/arm64 mcr.microsoft.com/dotnet/aspnet:8.0-jammy-arm64v8 AS runtime
WORKDIR /publish
