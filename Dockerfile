FROM --platform=linux/amd64 mcr.microsoft.com/dotnet/sdk:8.0.416-jammy-amd64 AS build-env
...
FROM --platform=linux/amd64 mcr.microsoft.com/dotnet/aspnet:8.0-jammy-amd64 AS runtime
WORKDIR /publish
