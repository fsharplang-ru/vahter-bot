...
app.MapPost("/test/mock/chat", Func<HttpContext, Threading.Tasks.Task>(fun ctx -> setMockChat ctx)) |> ignore
app.MapPost("/test/mock/rejectMdv2", Func<HttpContext, Threading.Tasks.Task>(fun ctx -> setRejectMdv2 ctx)) |> ignore
